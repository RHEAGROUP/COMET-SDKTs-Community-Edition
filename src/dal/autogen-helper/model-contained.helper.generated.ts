...
export class ModelContainedHelper {
  public static readonly ModelContainedClassKind = [
    Dto.ClassKind.ActionItem,
    Dto.ClassKind.Approval,
    ...
    Dto.ClassKind.File,
    Dto.ClassKind.FileRevision,
    Dto.ClassKind.Folder,
    Dto.ClassKind.Iteration,
