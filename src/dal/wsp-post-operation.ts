...
/**
 * The WSP POST operation
 */
export class WspPostOperation {
  ...
  public constructFromOperation(operation: Operation) {
    ...
    if (operation.operationKind == OperationKind.Update && operation.originalThing == null) {
      throw new Error('When OperationKind is an Update the OriginalThing of the operation may not be null');
    }
